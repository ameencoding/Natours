...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibW9oYW1lZGFtZWVuMTIwIiwiYSI6ImNraWxqcGVtdzBpcTIzMnA5d293eGRlOTIifQ.UUmZ2NJ8_FXGZ-7yHnQuTg';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, " : ").concat(loc.description, "</p>")).addTo(map); // extend map bounds to enclude current location
...
var stripe = Stripe('pk_test_51HzGEBLjXf9JGKBE8McA62OIbJEHzpMejC6zx22RfugwvoRlFk7UofpKAqr7WkRBG4yndI8JqOEfvGnthdTx46ij00LmJrovj3');
